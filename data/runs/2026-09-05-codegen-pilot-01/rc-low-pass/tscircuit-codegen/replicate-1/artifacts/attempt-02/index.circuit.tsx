export default () => (
  <board width="35mm" height="25mm" layers={2}
    ...
    minTraceToPadEdgeClearance="0.25mm" minPadEdgeToPadEdgeClearance="0.25mm" minBoardEdgeClearance="0.25mm" minViaEdgeToPadEdgeClearance="0.25mm">
    ...
    <resistor name="R1" resistance="1k" footprint="0805" pcbX={0} pcbY={1.27} schX={0} schY={-1.58} />
    <capacitor name="C1" capacitance="100nF" footprint="0805" pcbX={10} pcbY={0} pcbRotation={90} schX={2.5} schY={-1} schRotation={90} />
    <net name="SIGNAL_IN" />
    <net name="SIGNAL_OUT" />
    <net name="GND" />
    <trace name="T1" from=".J1 > .pin1" to=".R1 > .pin1" thickness="0.25mm" />
    <trace name="T2" from=".R1 > .pin1" to="net.SIGNAL_IN" thickness="0.25mm" />
    <trace name="T3" from=".R1 > .pin2" to=".J2 > .pin1" thickness="0.25mm" />
    <trace name="T4" from=".C1 > .pin1" to=".R1 > .pin2" thickness="0.25mm" />
    <trace name="T5" from=".R1 > .pin2" to="net.SIGNAL_OUT" thickness="0.25mm" />
    <trace name="T6" from=".J1 > .pin2" to="net.GND" thickness="0.25mm" />
    <trace name="T7" from=".J2 > .pin2" to="net.GND" thickness="0.25mm" />
    <trace name="T8" from=".C1 > .pin2" to="net.GND" thickness="0.25mm" />
