...
export default () => <board width="65mm" height="65mm" layers={2}
  minTraceWidth="0.25mm" routingTolerances={{minTraceWidth:0.25,minTraceToPadEdgeClearance:0.25,minPadEdgeToPadEdgeClearance:0.25,minViaEdgeToPadEdgeClearance:0.25,minBoardEdgeClearance:0.25}}
  ...
  <pinheader name="J1" pinCount={6} pitch="2.54mm" gender="male" footprint="pinrow6_p2.54mm"
    pinLabels={signals} showSilkscreenPinLabels pcbX={0} pcbY={28} schX={-6} schY={0} schSectionName="Interface" />
