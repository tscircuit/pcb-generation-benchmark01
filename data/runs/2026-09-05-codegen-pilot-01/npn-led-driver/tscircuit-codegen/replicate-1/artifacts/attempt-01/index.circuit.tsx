export default () => <board width="45mm" height="30mm" layers={2} minTraceWidth="0.25mm" autorouter={{preset:"auto_local",traceClearance:0.25}}>
  ...
  <pinheader name="J1" pinCount={4} pitch="2.54mm" gender="male" footprint="pinrow4_p2.54mm" pinLabels={["V5","GND","CTRL1","CTRL2"]} showSilkscreenPinLabels pcbX={-16} pcbY={0} pcbRotation={90} schX={-10} schY={0} schSectionName="IO" />
  ...
  {[1,2].map((i)=>{const x=i===1?-3:12;const s=i===1?0:9;return <group key={i}>
    <chip name={`Q${i}`} manufacturerPartNumber="MMBT3904LT1G" footprint="sot23" pinLabels={{pin1:"B",pin2:"E",pin3:"C"}} schPinArrangement={{leftSide:{pins:["B"],direction:"top-to-bottom"},rightSide:{pins:["C","E"],direction:"top-to-bottom"}} pcbX={x} pcbY={-2} schX={s} schY={0} schSectionName={`CH${i}`}/>
    ...
    <resistor name={`R${i===1?3:6}`} resistance="100k" footprint="0805" pcbX={x} pcbY={-7} schX={s-2} schY={-3} schRotation={90} schSectionName={`CH${i}`}/>
  </group>})}
