export default () => (
  <board width="50mm" height="30mm" layers={2} minTraceWidth="0.25mm" autorouter={{preset:"auto_local",traceClearance:"0.35mm"}} routingTolerances={{minTraceWidth:"0.25mm",minTraceToPadEdgeClearance:"0.25mm",minPadEdgeToPadEdgeClearance:"0.25mm",minViaEdgeToPadEdgeClearance:"0.25mm"}}>
    <schematicsection name="Left" displayName="Left channel" />
    <schematicsection name="Right" displayName="Right channel" />
    <pinheader name="J1" pinCount={3} pitch="2.54mm" gender="male" pcbX={-22} pcbY={0} pcbRotation={270} schX={-7} schY={0} pinLabels={["LEFT_IN","GND","RIGHT_IN"]} showSilkscreenPinLabels />
    <pinheader name="J2" pinCount={3} pitch="2.54mm" gender="male" pcbX={22} pcbY={0} pcbRotation={270} schX={7} schY={0} pinLabels={["LEFT_OUT","GND","RIGHT_OUT"]} showSilkscreenPinLabels />
    <capacitor name="C1" capacitance="1uF" schOrientation="vertical" footprint="0805" pcbX={-12} pcbY={8} schX={-3} schY={4} schSectionName="Left" />
    <resistor name="R1" resistance="10k" footprint="0805" pcbX={0} pcbY={8} schX={0} schY={2} schSectionName="Left" />
    ...
    <capacitor name="C2" capacitance="1uF" schOrientation="vertical" footprint="0805" pcbX={-12} pcbY={-8} schX={-3} schY={-4} schSectionName="Right" />
    <resistor name="R3" resistance="10k" footprint="0805" pcbX={0} pcbY={-8} schX={0} schY={-6} schSectionName="Right" />
    ...
    ].flatMap(([name,pins]) => [<net name={name as string} />, ...(pins as string[]).map(pin => <trace from={`.${pin.replace(".", " > .")}`} to={`net.${name}`} thickness="0.25mm" />)])}
