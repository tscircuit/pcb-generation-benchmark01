...
// 1N5819HW SOD-123: pin 1 cathode (band), pin 2 anode.
...
export default () => <board width="70mm" height="50mm" layers={2}
  ...
  autorouter={{preset:"auto_local",traceClearance:0.35}}>
  <schematicsection name="Power" />
  <schematicsection name="Control" />
  <net name="V12" /><net name="GND" />
  <pinheader name="J1" pinCount={2} pitch="2.54mm" footprint="pinrow2_p2.54mm" pinLabels={["V12","GND"]} showSilkscreenPinLabels pcbX={-29} pcbY={18} schX={-18} schY={9.32} schSectionName="Power" />
  <capacitor name="C1" capacitance="10uF" maxVoltageRating="25V" footprint="0805" pcbX={-24} pcbY={19} schX={-14} schY={10} schRotation={90} schSectionName="Power" />
  <capacitor name="C2" capacitance="100nF" maxVoltageRating="25V" footprint="0805" pcbX={-24} pcbY={15} schX={-10} schY={10} schRotation={90} schSectionName="Power" />
  <pinheader name="J2" schWidth={0.675} pinCount={5} pitch="2.54mm" footprint="pinrow5_p2.54mm" pinLabels={["GND","CTRL1","CTRL2","CTRL3","CTRL4"]} showSilkscreenPinLabels pcbX={-27} pcbY={-6} pcbRotation={90} schX={-18} schY={0} schSectionName="Control" />
  ...
  {channels.map((i) => {const y=18-(i-1)*12;const sy=12-(i-1)*9;return <>
    ...
    <chip name={`Q${i}`} schPinArrangement={{leftSide:{pins:[1]},rightSide:{pins:[3,2]}}} footprint="sot23" manufacturerPartNumber="AO3400A" pinLabels={{pin1:["gate"],pin2:["source"],pin3:["drain"]}} pcbX={17} pcbY={y} schX={2} schY={sy} schSectionName={`Channel${i}`} />
    <resistor name={`R${2*i-1}`} resistance="100" footprint="0805" pcbX={7} pcbY={y+2} schX={-3} schY={sy+0.75} schSectionName={`Channel${i}`} />
    ...
    <diode name={`D${i}`} footprint="sod123" manufacturerPartNumber="1N5819HW" pinLabels={{pin1:["cathode"],pin2:["anode"]}} pcbX={25} pcbY={y} schX={7} schY={sy+1} schRotation={90} schSectionName={`Channel${i}`} />
