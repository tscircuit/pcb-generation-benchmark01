...
export default () => <board width="70mm" height="50mm" layers={2}
  ...
  autorouter={{preset:"auto_local",traceClearance:0.5}}>
  ...
  {channels.map((i) => {const y=18-(i-1)*12;const sy=12-(i-1)*9;return <>
    ...
    <chip name={`Q${i}`} schPinArrangement={{leftSide:[1],rightSide:[3,2]}} footprint="sot23" manufacturerPartNumber="AO3400A" pinLabels={{pin1:["gate"],pin2:["source"],pin3:["drain"]}} pcbX={17} pcbY={y} schX={2} schY={sy} schSectionName={`Channel${i}`} />
